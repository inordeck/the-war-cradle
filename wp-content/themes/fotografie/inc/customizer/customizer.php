...
function fotografie_customize_register( $wp_customize ) {
	// Important Links.
	class FotografieImportantLinks extends WP_Customize_Control {
	...
	class FotografieCustomizeDropdownCategoriesControl extends WP_Customize_Control {
	...
	class FotografieNoteControl extends WP_Customize_Control {
	...
	$wp_customize->add_control( new FotografieImportantLinks( $wp_customize, 'fotografie_important_links', array(
